...
<body class="bg-taupe">
	...
	<div class="container page-content titleMenu">	
		...
		<div>
            <ul class="h-menu block-shadow-impact bg-grayDark">
                ...
                <li><a href="jsp/searchInfo/StoreSearch.jsp" class="fg-white sub-header bg-lighterBlue"><span class="mif-shop mif-lg"></span>&nbsp;&nbsp;商铺</a></li>
                 <li>
	...
	<div class="margin100 no-margin-top no-margin-bottom bg-grayLighter">
	    ...
	    <p class="minor-header" id="area">
			...
			<!-- <a href="#" class="fg-grayLight padding10">全北京</a>
			<a href="#" class="fg-grayLight padding10">朝阳</a>
			<a href="#" class="fg-grayLight padding10">海淀</a>
			<a href="#" class="fg-grayLight padding10">东城</a>
			<a href="#" class="fg-grayLight padding10">西城</a>
			<a href="#" class="fg-grayLight padding10">崇文</a>
			<a href="#" class="fg-grayLight padding10">宣武</a>
			<a href="#" class="fg-grayLight padding10">丰台</a>
			<a href="#" class="fg-grayLight padding10">通州</a>
			<a href="#" class="fg-grayLight padding10">石景山</a>
			<a href="#" class="fg-grayLight padding10">房山</a>
			<a href="#" class="fg-grayLight padding10">昌平</a>	
			<a href="#" class="fg-grayLight padding10">大兴</a>	
			<a href="#" class="fg-grayLight padding10">顺义</a>	
			<a href="#" class="fg-grayLight padding10">密云</a>	
			<a href="#" class="fg-grayLight padding10">怀柔</a>	
			<a href="#" class="fg-grayLight padding10">延庆</a><br/>	
			<a href="#" class="fg-grayLight padding10 
			margin40 no-margin-bottom no-margin-top no-margin-right">平谷</a>	
			<a href="#" class="fg-grayLight padding10">门头沟</a>	
			<a href="#" class="fg-grayLight padding10">燕郊</a>	
			<a href="#" class="fg-grayLight padding10">北京周边</a>	 -->
		</p>
	    <p class="minor-header" id="storeClassify">
		    <span class="fg-red">分类：</span>
		  <!--   <a href="#" class="fg-grayLight padding10">商铺租售</a>	
		    <a href="#" class="fg-grayLight padding10">生意转让</a>	 -->
		</p>
		<p class="minor-header" id="storeSupply">
			<span class="fg-red">供求：</span>
		    <!-- <a href="#" class="fg-grayLight padding10">出租</a>	
		    <a href="#" class="fg-grayLight padding10">出售</a>	
		    <a href="#" class="fg-grayLight padding10">求租</a>	
		    <a href="#" class="fg-grayLight padding10">求购</a>	 -->
		</p>
		<p class="minor-header" id="storeType">
			<span class="fg-red">类型：</span>
		    <!-- <a href="#" class="fg-grayLight padding10">全部</a>	
		    <a href="#" class="fg-grayLight padding10">商业街卖场</a>	
		    <a href="#" class="fg-grayLight padding10">写字楼配套</a>	
		    <a href="#" class="fg-grayLight padding10">住宅底商</a>	
		    <a href="#" class="fg-grayLight padding10">摊位柜台</a>	
		    <a href="#" class="fg-grayLight padding10">其他</a>	 -->
		</p>
	    ...
	    <button class="button fg-red" id="searchBtn"><span class="mif-search fg-red"></span> 搜索</button>
		 ...
		 <!--条件选择部分结束-->
		<!--搜索内容部分-->
    	<div class="tabcontrol" data-role="tabcontrol" id="storeSource">
	        <ul class="tabs">
	            <!-- <li><a href="#frame_1_1">全部</a></li>
	            <li><a href="#frame_1_2">个人</a></li>
	            <li><a href="#frame_1_3">商家</a></li> -->
	        </ul>
...
<!--foot部分-->
	...
	<script type="text/javascript" src="jsp/f-js/searchInfo/StoreSearch.js"></script>
	<script type="text/javascript">
		$(function(){
			StoreSearch.init();
