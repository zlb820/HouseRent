...
<head>
	...
	<script type="text/javascript" src="jsp/f-js/searchInfo/StoreDetail.js"></script>
		...
		<div class="row cells2">
			<div class="cell">
				<div id="car_m_2" class="carousel" data-role="carousel" data-height="500" data-controls="false" data-markers="false" data-auto="false">
                    <div class="slide"><img src="${store.pic01 }" data-role="fitImage" data-format="fill"></div>
                    <div class="slide"><img src="${store.pic02 }" data-role="fitImage" data-format="fill"></div>
                    <div class="slide"><img src="${store.pic03 }" data-role="fitImage" data-format="fill"></div>
                    <div class="slide"><img src="${store.pic04 }" data-role="fitImage" data-format="fill"></div>
                </div>
                <div id="car_m_2_thumbs" class="padding10 align-center">
                    <div class="thumb" data-index="1"><img src="${store.pic01 }" data-role="fitImage" data-format="fill"/></div>
                    <div class="thumb" data-index="2"><img src="${store.pic02 }" data-role="fitImage" data-format="fill"/></div>
                    <div class="thumb" data-index="3"><img src="${store.pic03 }" data-role="fitImage" data-format="fill"/></div>
                    <div class="thumb" data-index="4"><img src="${store.pic04 }" data-role="fitImage" data-format="fill"/></div>
                </div>
                <script>
                    $(function(){
			...
			<div class="cell padding20">
				<p class="sub-header padding30 no-padding-bottom no-padding-top">${store.location } ${store.title }</p>
				<p class="sub-header padding6">租金：<span class="fg-red sub-header">￥<span class="sub-leader">${store.price }</span>元/月 </span> 押一付三</p>
				<p class="sub-header padding6">面积：${store.proportation }平米</p>
				<p class="sub-header padding6">朝向：${store.direction }</p>
				<p class="sub-header padding6">楼层：${store.floor }层</p>
				<p class="sub-header padding6">联系人：${store.linkMan }</p>
				<p class="sub-header padding6">联系方式：</p>
				<p><button class="command-button warning"><span class="icon mif-phone-in-talk fg-white"></span>${store.tel }</button></p>
			</div>	
		</div>
	</div>
			...
			<div class="cell colspan4">
				<div class="cell">
					<div class="panel">
                            ...
                            <div class="content padding20">
	                            <span class="align-center"><img src="${store.pic01 }" width="100%" height="500"/></span>
	                            <span class="align-center"><img src="${store.pic02 }" width="100%" height="500"/></span>
	                            <span class="align-center"><img src="${store.pic03 }" width="100%" height="500"/></span>
	                            <span class="align-center"><img src="${store.pic04 }" width="100%" height="500"/></span>
                            </div>
                        </div>
				</div>
			</div>
