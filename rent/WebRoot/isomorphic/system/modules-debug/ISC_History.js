...
isc.version = "v9.1p_2014-11-06/Pro Development Only";
isc.versionNumber = "v9.1p_2014-11-06";
isc.buildDate = "2014-11-06";
isc.expirationDate = "";

// license template data
isc.licenseType = "Pro";
isc.licenseCompany = "Isomorphic Software";
isc.licenseSerialNumber = "ISC_PRO_NIGHTLY";
...
isc._optionalModules = {
    ...
    Drawing: {present: "${includeDrawing}", name: "Drawing Module"},
