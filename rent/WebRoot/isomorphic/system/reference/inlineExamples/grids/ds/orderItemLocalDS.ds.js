...
{pk:0, orderID:8805, itemDescription:"Anti Virus Suite",
    category:"Software", shipDate:new Date(2010,2,5), quantity:2 , unitPrice:50 },
...
{pk:7, orderID:9373, itemDescription:"On-site Training",
    category:"Services", shipDate:new Date(2009,10,10), quantity:20 , unitPrice:100 },
{pk:8, orderID:9311, itemDescription:"Software Development Kit",
    category:"Software", shipDate:new Date(2010,1,20), quantity:8 , unitPrice:249.99 },
{pk:9, orderID:7806, itemDescription:"15 inch flat panel monitor",
    category:"Hardware", shipDate:new Date(2009,10,13), quantity:4 , unitPrice:300 },
{pk:10, orderID:8620, itemDescription:"18 inch flat panel monitor",
    category:"Hardware", shipDate:new Date(2010,1,2), quantity:2 , unitPrice:375 },
{pk:11, orderID:629, itemDescription:"Office Productivity Suite", 
    category:"Software", shipDate:new Date(2010,2,5), quantity:15 , unitPrice:64.99 },
{pk:12, orderID:1264, itemDescription:"Office Productivity Suite",
    category:"Software", shipDate:new Date(2010,2,5), quantity:2 , unitPrice:64.99 },
...
{pk:14, orderID:9647, itemDescription:"Consulting Services",
    category:"Services", shipDate:new Date(2009,10,10), quantity:10 , unitPrice:100 },
{pk:15, orderID:8468, itemDescription:"USB Optical Mouse",
    category:"Hardware", shipDate:new Date(2009,10,13), quantity:5 , unitPrice:29.99 },
{pk:16, orderID:9496, itemDescription:"Off-site Training",
    category:"Services", shipDate:new Date(2009,10,10), quantity:35 , unitPrice:80 },
...
{pk:18, orderID:1799, itemDescription:"Office Application Suite",
    category:"Software", shipDate:new Date(2010,1,20), quantity:22 , unitPrice:30 },
{pk:19, orderID:7020, itemDescription:"Consulting Services",
    category:"Services", shipDate:new Date(2009,10,10), quantity:100 , unitPrice:80 }
];
